...
const schema = async () => {
    ...
    const paths = [
        ...
        'llvm-project/mlir/examples/standalone/include',
        'llvm-project/mlir/examples/toy/Ch7/include',
        'llvm-project/mlir/examples/transform/Ch2/include',
        'llvm-project/mlir/examples/transform/Ch3/include',
        'llvm-project/mlir/examples/transform/Ch4/include',
        'stablehlo',
        'shardy',
        'xla/xla/mlir_hlo',
        'xla',
        ...
        'triton/include',
        'triton/third_party',
        'triton/third_party/amd/include/Dialect/TritonAMDGPU/IR',
        'iree/compiler/src',
        'iree/compiler/src/iree/compiler/Codegen/Dialect/PCF/IR',
        'iree/compiler/src/iree/compiler/Modules/IO/Parameters/IR',
        'FlashTensor/include',
        'tpu-mlir/include',
        'tensorflow',
        'tensorflow/tensorflow/core/ir',
        'tensorflow/tensorflow/compiler/mlir/tfrt/ir',
        'xla/xla/backends/gpu/codegen/triton/ir',
        'runtime/include',
        'plaidml',
        'plaidml/pmlc/dialect/pxa/ir',
        'mlir-dace/include',
        'lltz/mlir/dialect/include/Michelson',
        'lagrad/include/LAGrad',
        'TensorRT-Incubator/mlir-tensorrt/tensorrt/include',
        ...
        'triton/examples/plugins/DialectPlugins/DialectPlugin/include',
        'clangir',
        'clangir/clang/include',
        'rocMLIR',
        'rocMLIR/mlir/include',
        'ensemble-compilation/lib/Dialect/Ensemble',
    ...
    const dialects = [
        ...
        'triton/examples/plugins/DialectPlugins/DialectPlugin/include/DialectPlugin/DialectPluginOps.td',
        ...
        'mlir-tensorrt/Compiler/Dialect/CUDA/IR/CUDAOps.td',
        'mlir-tensorrt/Compiler/Dialect/TensorRTRuntime/IR/TensorRTRuntimeOps.td',
        'mlir-tensorrt/Compiler/Dialect/Plan/IR/PlanOps.td',
...
const test = async (pattern) => {
    ...
    const invalidFiles = new Set([
        ...
        'third_party/source/mlir/llvm-project/mlir/test/IR/dense-elements-type-interface.mlir',
